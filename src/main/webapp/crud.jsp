...
<div class="container">
    <div class="table-wrapper">
                    ...
                    <tr>
                        <td>
                                    <span class="custom-checkbox">
                                        ...
                                        <label for="checkbox<%=subject.getId()%>"></label>
                                    </span>
                        </td>
                        <td><%=subject.getTitle()%></td>
                        <td><%=subject.getSemester().getName()%></td>
        ...
        <div class="clearfix">
            ...
            %>
            <div class="hint-text">Showing <b>5</b> out of <b><%=countSub%></b> entries</div>
            <ul class="pagination">
...
<div id="addEmployeeModal" class="modal fade">
    <div class="modal-dialog">
        <div class="modal-content">
            <form method="post" action="/demo2_war_exploded/admin?action=add" accept-charset="UTF-8">
            <div class="modal-header">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input name="semester" type="text" class="form-control" required oninput="this.value = this.value.replace(/[^0-9]/g, '');">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <label>Recommend teacher 1</label>
                        <input name="fav-teacher1" type="text" class="form-control" required>
                    </div>
                    <div class="form-group">
                        <label>Recommend teacher 2</label>
                        <input name="fav-teacher2" type="text" class="form-control" required>
                    </div>
                    <div class="form-group">
                        <label>Recommend teacher 3</label>
                        <input name="fav-teacher3" type="text" class="form-control" required>
                    </div>
                    <div class="form-group">
                        <label>Midterm link</label>
                        <input name="midterm" type="text" class="form-control" required>
                    </div>
                    <div class="form-group">
                        <label>Final exam link</label>
                        <input name="final" type="text" class="form-control" required>
                    </div>
                    <div class="form-group">
                        <label>Relating document</label>
                        <input name="relate" type="text" class="form-control" required>
                    </div>
                </div>
